          ...
          <div class="container">
               <div class="row">
                   ...
                   <div class="col-md-4 col-sm-5">
                         <p><?php echo $username;?>, 
						 <?php if($_SESSION["Lang"]=="ENGLISH") {  ?>  Welcome to Health MED Scheduler<?php } ?>
          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         <li><a href="AdminHome.php" class="smoothScroll">
						  <?php if($_SESSION["Lang"]=="ENGLISH") {  ?>Home
						 <?php } ?>
						 <?php if($_SESSION["Lang"]=="ARABIC") {  ?> الصفحة الأمامية<?php } ?>
						 </a></li>
                         <li><a href="AdminPatients.php" class="smoothScroll">
						 <?php if($_SESSION["Lang"]=="ENGLISH") {  ?>Patients
						 <?php } ?>
						 <?php if($_SESSION["Lang"]=="ARABIC") {  ?> مرضى<?php } ?>
						 </a></li>
                         <li><a href="AdminDoctors.php" class="smoothScroll">
						 <?php if($_SESSION["Lang"]=="ENGLISH") {  ?>Doctors
						 <?php } ?>
						 <?php if($_SESSION["Lang"]=="ARABIC") {  ?> الأطباء<?php } ?>
						 </a></li>
